...
copyright = '{{ cookiecutter.repo_name }} Authors'
author = '{{ cookiecutter.author }}'

_version_bits = {{ cookiecutter.package_name }}.__version__.split('.')
...
man_pages = [
    (master_doc, '{{ cookiecutter.package_name }}', '{{ cookiecutter.repo_name }} Documentation',
     [author], 1)
]
...
# GitHub repo
issues_github_path = "{{ cookiecutter.gh_repo_name }}"
