...
We are very grateful for your continuing support for {{ cookiecutter.repo_name }}!
...
The following people in alphabetical order contributed to the {{ cookiecutter.repo_name }} project
in other ways.
...
{{ cookiecutter.repo_name }} kindly acknowledges funding and support from the following sources:
